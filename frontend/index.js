...
(function($PS) {
  ...
  var showMusician = function (m) {
      return Halogen_HTML_Elements.ul_([ Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Core.text(m.musicianName) ]), Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Core.text(m.musicianDOB) ]), Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Core.text(m.musicianDOD) ]), Halogen_HTML_Elements.li([  ])([ Halogen_HTML_Core.text(Data_Show.show(Data_Show.showArray(Data_Show.showString))(m.musicianCharacteristics)) ]) ]);
  };
  var showMusicians = function (v) {
      if (v instanceof Data_Maybe.Just) {
          return Data_Functor.map(Data_Functor.functorArray)(showMusician)(v.value0);
      };
      if (v instanceof Data_Maybe.Nothing) {
          return [ Halogen_HTML_Elements.span([  ])([ Halogen_HTML_Core.text("") ]) ];
      };
      throw new Error("Failed pattern match at Main (line 54, column 1 - line 54, column 79): " + [ v.constructor.name ]);
  };
  var initialState = {
      loading: true,
      username: "Dave",
      musicians: Data_Maybe.Nothing.value
  };
  var handleResponse = function (r) {
      ...
      if (r instanceof Data_Either.Right) {
          return new Data_Maybe.Just(r.value0);
      };
      throw new Error("Failed pattern match at Main (line 92, column 3 - line 94, column 38): " + [ r.constructor.name ]);
  };
  var component = (function () {
      var render = function (state) {
          return Halogen_HTML_Elements.div_(showMusicians(state.musicians));
      };
      var handleAction = function (v) {
          if (v instanceof Initialize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("Initialize")))(function () {
                  return Control_Bind.bind(Halogen_Query_HalogenM.bindHalogenM)(Effect_Aff_Class.liftAff(Halogen_Query_HalogenM.monadAffHalogenM(Effect_Aff_Class.monadAffAff))(Affjax.get(Affjax_ResponseFormat.string)("http://localhost:8081/musicians")))(function (v1) {
                      var musicians = handleResponse(Simple_JSON.readJSON(Simple_JSON.readArray(Simple_JSON.readRecord()(Simple_JSON.readFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "musicianCharacteristics";
                          ...
                          return "musicianName";
                      }))(Simple_JSON.readString)(Simple_JSON.readFieldsNil)()())()())()())()())()())))(Data_Either.either(Data_Function["const"](""))(Control_Category.identity(Control_Category.categoryFn))(v1.body)));
                      return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("Musicians: " + Data_Show.show(Data_Maybe.showMaybe(Data_Show.showArray(Data_Show.showRecord()(Data_Show.showRecordFieldsCons(new Data_Symbol.IsSymbol(function () {
                          return "musicianCharacteristics";
                          ...
                          return "musicianName";
                      }))(Data_Show.showRecordFieldsNil)(Data_Show.showString))(Data_Show.showInt))(Data_Show.showString))(Data_Show.showString))(Data_Show.showArray(Data_Show.showString))))))(musicians))))(function () {
          ...
          if (v instanceof Finalize) {
              return Control_Bind.discard(Control_Bind.discardUnit)(Halogen_Query_HalogenM.bindHalogenM)(Effect_Class.liftEffect(Halogen_Query_HalogenM.monadEffectHalogenM(Effect_Aff.monadEffectAff))(Effect_Console.log("Finalize")))(function () {
                  return Control_Applicative.pure(Halogen_Query_HalogenM.applicativeHalogenM)(Data_Unit.unit);
              });
          };
          throw new Error("Failed pattern match at Main (line 75, column 3 - line 75, column 76): " + [ v.constructor.name ]);
      };
  ...
  exports["showMusician"] = showMusician;
  exports["showMusicians"] = showMusicians;
